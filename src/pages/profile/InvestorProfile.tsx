  ...
  if (!investor || investor.role !== 'investor') {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-slate-100">Investor not found</h2>
        <p className="text-slate-400 mt-2">The investor profile you're looking for doesn't exist or has been removed.</p>
    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <CardBody className="sm:flex sm:items-start sm:justify-between p-6">
          <div className="sm:flex sm:space-x-6">
            ...
            <div className="mt-4 sm:mt-0 text-center sm:text-left">
              ...
              <p className="text-slate-400 flex items-center justify-center sm:justify-start mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              <h2 className="text-lg font-medium text-slate-100">About</h2>
            </CardHeader>
            <CardBody>
          ...
          <Card>
            <CardHeader>
              <h2 className="text-lg font-medium text-slate-100">Investment Interests</h2>
            </CardHeader>
            <CardBody>
              <div className="space-y-4">
                <div>
                  <h3 className="text-md font-medium text-slate-100">Industries</h3>
                ...
                <div>
                  <h3 className="text-md font-medium text-slate-100">Investment Stages</h3>
                  <div className="flex flex-wrap gap-2 mt-2">
                    {investor.investmentStage.map((stage, index) => (
                ...
                <div>
                  <h3 className="text-md font-medium text-slate-100">Investment Criteria</h3>
          ...
          <Card>
            <CardHeader className="flex justify-between items-center">
              <h2 className="text-lg font-medium text-slate-100">Portfolio Companies</h2>
              <span className="text-sm text-slate-400">{investor.portfolioCompanies.length} companies</span>
            </CardHeader>
            <CardBody>
                ...
                {investor.portfolioCompanies.map((company, index) => (
                  <div key={index} className="flex items-center p-3 border border-gray-200 rounded-md">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Invested in 2022</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <h2 className="text-lg font-medium text-slate-100">Investment Details</h2>
            </CardHeader>
            <CardBody>
              <div className="space-y-4">
                <div>
                  <span className="text-sm text-slate-400">Investment Range</span>
                ...
                <div>
                  ...
                  <p className="text-md font-medium text-slate-100">{investor.totalInvestments} companies</p>
                </div>
                
                <div>
                  <span className="text-sm text-slate-400">Typical Investment Timeline</span>
                  <p className="text-md font-medium text-slate-100">3-5 years</p>
                </div>
                
                <div className="pt-3 border-t border-gray-100">
                  <span className="text-sm text-slate-400">Investment Focus</span>
          ...
          <Card>
            <CardHeader>
              <h2 className="text-lg font-medium text-slate-100">Investment Stats</h2>
            </CardHeader>
            <CardBody>
              <div className="space-y-3">
                <div className="p-3 border border-gray-200 rounded-md bg-gray-50">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-sm font-medium text-slate-100">Successful Exits</h3>
                ...
                <div className="p-3 border border-gray-200 rounded-md bg-gray-50">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-sm font-medium text-slate-100">Avg. ROI</h3>
                ...
                <div className="p-3 border border-gray-200 rounded-md bg-gray-50">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-sm font-medium text-slate-100">Active Investments</h3>
